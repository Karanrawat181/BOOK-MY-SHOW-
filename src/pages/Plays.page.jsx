...
import PlaysFilters from '../components/PlaysFilters/PlaysFilters.comopnent'
            ...
            <div className="container mx-auto px-4 lg:px-20">
                ...
                <div className="lg:w-3/12">
                 ...
                 <h2 className="text-2xl font-bold mb-4"> Filters </h2>
                   ...
                   <PlaysFilters title="Date" tags={["Today","Tommorow","ThisWekend"]}  />
                   <PlaysFilters title="Language" tags={["Hindi","English","Telgue"]}  />
